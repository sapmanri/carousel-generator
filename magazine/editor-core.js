...
## 안전한 추상 리듬 대신 구체 장면으로 (예시)
아래처럼 안전하고 추상적인 문장으로 도망치지 말고, 사물·거리·동작·숫자로 구체화하세요.
❌ "그냥 있었다." / "서두르지 않았다." / "빠르지도 느리지도 않았다."
⭕ "커피잔 손잡이와 고양이 꼬리 사이, 손가락 두 개 정도 거리."
❌ "그런 오후였다." / "충분했다."
⭕ "식은 차 옆에 다 읽지 못한 책이 엎어져 있었다."
같은 상황을 묘사할 때, 감정을 직접 말하지 말고 이렇게 구체적인 하나의 장면·사물·거리로 대체하세요.
